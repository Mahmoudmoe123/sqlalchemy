...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgress:notrealpassword@localhost/movies'
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
db.init_app(app)  # Initialize the db object with the app instance
